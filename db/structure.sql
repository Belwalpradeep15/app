...
--
-- Name: fotech_config_changes_notifier(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fotech_config_changes_notifier() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin
...
CREATE TABLE alerts (
    ...
    CONSTRAINT valid_threat_level CHECK (((threat_level IS NULL) OR ((threat_level)::text = ANY (ARRAY[('clear'::character varying)::text, ('green'::character varying)::text, ('amber'::character varying)::text, ('red'::character varying)::text]))))
);
...
CREATE TABLE health_components (
    ...
    message character varying(255),
    statuses character varying(255),
    CONSTRAINT health_components_component CHECK (((component)::text = ANY (ARRAY[('cabinet'::character varying)::text, ('panoptes'::character varying)::text, ('helios'::character varying)::text, ('comms'::character varying)::text, ('relay'::character varying)::text, ('cable'::character varying)::text])))
);
...
CREATE TABLE helios_units (
    ...
    ws_port integer DEFAULT 57006 NOT NULL,
    CONSTRAINT enforce_dims_location CHECK ((st_ndims(location) = 2)),
    CONSTRAINT enforce_geotype_location CHECK (((geometrytype(location) = 'POINT'::text) OR (location IS NULL))),
    CONSTRAINT enforce_srid_location CHECK ((st_srid(location) = (-1))),
...
--
-- Name: marker_types; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: marker_types_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE marker_types_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: marker_types_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE marker_types_id_seq OWNED BY marker_types.id;
...
CREATE TABLE markers (
    ...
    created_at timestamp without time zone,
    updated_at timestamp without time zone,
    gis_location geometry,
    CONSTRAINT enforce_dims_gis_location CHECK ((st_ndims(gis_location) = 2)),
    CONSTRAINT enforce_geotype_gis_location CHECK (((geometrytype(gis_location) = 'POINT'::text) OR (gis_location IS NULL))),
    CONSTRAINT enforce_srid_gis_location CHECK ((st_srid(gis_location) = (-1))),
    CONSTRAINT markers_geometry CHECK (st_isvalid(gis_location))
);
...
--
-- Name: markers_marker_types; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE markers_marker_types (
    id integer NOT NULL,
...
--
-- Name: markers_marker_types_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE markers_marker_types_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: markers_marker_types_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE markers_marker_types_id_seq OWNED BY markers_marker_types.id;
...
CREATE TABLE notification_email_lists (
    ...
    created_at timestamp without time zone,
    updated_at timestamp without time zone,
    message_format character varying(255) DEFAULT 'Email'::character varying NOT NULL
);
...
--
-- Name: panoptes_units; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE panoptes_units (
    id integer NOT NULL,
    name character varying(255) NOT NULL,
    serial_number character varying(50) NOT NULL,
    host_name character varying(50) NOT NULL,
    ...
    CONSTRAINT enforce_geotype_location CHECK (((geometrytype(location) = 'POINT'::text) OR (location IS NULL))),
    CONSTRAINT enforce_srid_location CHECK ((st_srid(location) = (-1))),
    CONSTRAINT panoptes_units_geometry CHECK (st_isvalid(location))
);


--
-- Name: panoptes_units_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE panoptes_units_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: panoptes_units_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE panoptes_units_id_seq OWNED BY panoptes_units.id;
...
CREATE TABLE threat_configurations (
    ...
    event_aggregation_enabled boolean DEFAULT false NOT NULL,
    always_red_after_timeout_enabled boolean DEFAULT false NOT NULL,
    always_red_after_timeout_s double precision DEFAULT 600.0 NOT NULL,
    initial_threat_level character varying(255) DEFAULT 'clear'::character varying NOT NULL,
...
CREATE TABLE threat_increments (
    ...
    CONSTRAINT valid_name CHECK (((name)::text = ANY (ARRAY[('hold'::character varying)::text, ('low'::character varying)::text, ('medium'::character varying)::text, ('top'::character varying)::text])))
);
...
CREATE TABLE threat_thresholds (
    ...
    CONSTRAINT positive_threshold CHECK ((threshold > 0)),
    CONSTRAINT valid_name CHECK (((name)::text = ANY (ARRAY[('green'::character varying)::text, ('amber'::character varying)::text, ('red'::character varying)::text])))
);
...
--
-- Name: tz_world; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: tz_world_gid_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: tz_world_gid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
ALTER TABLE ONLY marker_types ALTER COLUMN id SET DEFAULT nextval('marker_types_id_seq'::regclass);
...
ALTER TABLE ONLY markers_marker_types ALTER COLUMN id SET DEFAULT nextval('markers_marker_types_id_seq'::regclass);
...
ALTER TABLE ONLY panoptes_units ALTER COLUMN id SET DEFAULT nextval('panoptes_units_id_seq'::regclass);
...
--
-- Name: marker_types_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY marker_types
    ADD CONSTRAINT marker_types_pkey PRIMARY KEY (id);


--
-- Name: markers_marker_types_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY markers_marker_types
    ADD CONSTRAINT markers_marker_types_pkey PRIMARY KEY (id);
...
--
-- Name: panoptes_units_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY panoptes_units
    ADD CONSTRAINT panoptes_units_pkey PRIMARY KEY (id);
...
--
-- Name: tz_world_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: fki_fk_alert_details_alert_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX fki_fk_alert_details_alert_id ON alert_details USING btree (alert_id);


--
-- Name: fki_fk_alert_responses_alert_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX fki_fk_alert_responses_alert_id ON alert_responses USING btree (alert_id);


--
-- Name: fki_fk_alerts_alert_maintainer_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX fki_fk_alerts_alert_maintainer_id ON alerts USING btree (alert_maintainer_id);


--
-- Name: fki_fk_event_tracks_alert_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX fki_fk_event_tracks_alert_id ON event_tracks USING btree (alert_id);


--
-- Name: fki_fk_events_alert_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX fki_fk_events_alert_id ON events USING btree (alert_id);
...
--
-- Name: index_locations_on_document_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_locations_on_document_id ON locations USING btree (document_id);


--
-- Name: index_locations_on_marker_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_locations_on_marker_id ON locations USING btree (marker_id);


--
-- Name: index_marker_types_on_name; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX index_marker_types_on_name ON marker_types USING btree (name);


--
-- Name: index_markers_on_name; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX index_markers_on_name ON markers USING btree (name);


--
-- Name: index_markers_on_organization_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_markers_on_organization_id ON markers USING btree (organization_id);
...
--
-- Name: index_on_panoptes_units_lower_name; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_on_panoptes_units_lower_name ON panoptes_units USING btree (lower((name)::text));
...
--
-- Name: panoptes_units_unique_serial_number; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX panoptes_units_unique_serial_number ON panoptes_units USING btree (serial_number);
...
--
-- Name: tz_world_geom_index; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX tz_world_geom_index ON tz_world USING gist (the_geom);


--
-- Name: fotech_config_changes_notifier_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER fotech_config_changes_notifier_trigger AFTER INSERT OR DELETE OR UPDATE ON helios_units FOR EACH STATEMENT EXECUTE PROCEDURE fotech_config_changes_notifier();
...
CREATE TRIGGER fotech_config_changes_notifier_trigger AFTER INSERT OR DELETE OR UPDATE ON fibre_lines FOR EACH STATEMENT EXECUTE PROCEDURE fotech_config_changes_notifier();
...
CREATE TRIGGER fotech_config_changes_notifier_trigger AFTER INSERT OR DELETE OR UPDATE ON event_types FOR EACH STATEMENT EXECUTE PROCEDURE fotech_config_changes_notifier();
...
CREATE TRIGGER fotech_config_changes_notifier_trigger AFTER INSERT OR DELETE OR UPDATE ON alert_configurations FOR EACH STATEMENT EXECUTE PROCEDURE fotech_config_changes_notifier();
...
CREATE TRIGGER fotech_config_changes_notifier_trigger AFTER INSERT OR DELETE OR UPDATE ON threat_configurations FOR EACH STATEMENT EXECUTE PROCEDURE fotech_config_changes_notifier();
...
CREATE TRIGGER fotech_config_changes_notifier_trigger AFTER INSERT OR DELETE OR UPDATE ON threat_increments FOR EACH STATEMENT EXECUTE PROCEDURE fotech_config_changes_notifier();
...
CREATE TRIGGER fotech_config_changes_notifier_trigger AFTER INSERT OR DELETE OR UPDATE ON threat_thresholds FOR EACH STATEMENT EXECUTE PROCEDURE fotech_config_changes_notifier();
...
CREATE TRIGGER fotech_config_changes_notifier_trigger AFTER INSERT OR DELETE OR UPDATE ON organizations FOR EACH STATEMENT EXECUTE PROCEDURE fotech_config_changes_notifier();
...
CREATE TRIGGER fotech_config_changes_notifier_trigger AFTER INSERT OR DELETE OR UPDATE ON organization_preferences FOR EACH STATEMENT EXECUTE PROCEDURE fotech_config_changes_notifier();
...
CREATE TRIGGER fotech_config_changes_notifier_trigger AFTER INSERT OR DELETE OR UPDATE ON panoptes_units FOR EACH STATEMENT EXECUTE PROCEDURE fotech_config_changes_notifier();
...
--
-- Name: fk_rails_4612946ff3; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY markers_marker_types
    ADD CONSTRAINT fk_rails_4612946ff3 FOREIGN KEY (marker_type_id) REFERENCES marker_types(id);


--
-- Name: fk_rails_886d5914bd; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY locations
    ADD CONSTRAINT fk_rails_886d5914bd FOREIGN KEY (document_id) REFERENCES documents(id);


--
-- Name: fk_rails_a3cadea4de; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY markers
    ADD CONSTRAINT fk_rails_a3cadea4de FOREIGN KEY (organization_id) REFERENCES organizations(id);


--
-- Name: fk_rails_ab367d22c8; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY locations
    ADD CONSTRAINT fk_rails_ab367d22c8 FOREIGN KEY (marker_id) REFERENCES markers(id);


--
-- Name: fk_rails_bedf276aeb; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY markers_marker_types
    ADD CONSTRAINT fk_rails_bedf276aeb FOREIGN KEY (marker_id) REFERENCES markers(id);
